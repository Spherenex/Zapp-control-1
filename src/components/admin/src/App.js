...
import ManageFooter from './pages/ManageFooter'; // Make sure this import exists
      ...
      <div className="app">
        ...
        <div className="content">
          <Routes>
            ...
            />
            {/* Add the missing route for Manage Footer */}
            <Route 
              path="/manage-footer" 
              element={user ? <ManageFooter /> : <Navigate to="/login" />} 
            />
            {/* Include ManageValues route if you're using it */}
